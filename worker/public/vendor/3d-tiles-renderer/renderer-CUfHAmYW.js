// Vendored from 3d-tiles-renderer@0.5.3 (npm, build/renderer-CUfHAmYW.js, see VERSION.txt) with its 3
// bare-specifier imports ('three', 'three/addons/...') rewritten to relative paths into
// ../three/ so this works without a bundler/import-map (2026-09-25, 渋谷マチマチ 高画質3D). To update:
// re-download the npm tarball, re-copy build/renderer-CUfHAmYW.js, and redo those 3 sed edits.
import { A as e, L as t, _ as n, d as r, f as i, i as a, k as o, n as s, r as c, t as l } from "./renderer-_7gAivIK.js";
import { Box3 as u, BufferAttribute as d, BufferGeometry as f, Clock as p, Color as m, DefaultLoadingManager as h, Euler as g, EventDispatcher as _, Frustum as v, Group as y, InstancedMesh as ee, LoadingManager as b, MathUtils as x, Matrix3 as te, Matrix4 as S, Mesh as ne, OrthographicCamera as re, PerspectiveCamera as ie, Plane as ae, PlaneGeometry as oe, Points as se, PointsMaterial as ce, Quaternion as C, Ray as le, Raycaster as ue, ShaderMaterial as de, Sphere as fe, Spherical as pe, TextureUtils as me, Vector2 as w, Vector3 as T } from "../three/three.module.js";
import { GLTFLoader as he } from "../three/examples/jsm/loaders/GLTFLoader.js";
import { estimateBytesUsed as ge } from "../three/examples/jsm/utils/BufferGeometryUtils.js";
...
var Pe = /* @__PURE__ */ new pe(), Fe = /* @__PURE__ */ new T(), E = /* @__PURE__ */ new T(), Ie = /* @__PURE__ */ new T(), D = /* @__PURE__ */ new S(), O = /* @__PURE__ */ new S(), Le = /* @__PURE__ */ new fe(), k = /* @__PURE__ */ new g(), Re = /* @__PURE__ */ new T(), ze = /* @__PURE__ */ new T(), Be = /* @__PURE__ */ new T(), Ve = /* @__PURE__ */ new T(), He = /* @__PURE__ */ new le(), Ue = 1e-12, We = .1, Ge = 0, Ke = 1, qe = 2, Je = class {
	constructor(e = 1, t = 1, n = 1) {
		this.isEllipsoid = !0, this.name = "", this.radius = new T(e, t, n);
	}
	intersectRay(e, t) {
...
}, P = /* @__PURE__ */ new T(), F = /* @__PURE__ */ new T(), I = /* @__PURE__ */ new T(), At = /* @__PURE__ */ new T(), jt = /* @__PURE__ */ new T(), Mt = class {
	constructor() {
...
var Vt = Symbol("INITIAL_FRUSTUM_CULLED"), Ht = /* @__PURE__ */ new S(), Ut = /* @__PURE__ */ new T(), Wt = /* @__PURE__ */ new w(), Gt = /* @__PURE__ */ new T(1, 0, 0), Kt = /* @__PURE__ */ new T(0, 1, 0), qt = () => null;
function Jt(e, t) {
	e.traverse((e) => {
...
var Yt = class extends n {
	...
	constructor(...e) {
		super(...e), this.accelerateRaycast = !0, this.group = new ft(this), this.ellipsoid = Ye.clone(), this.surface = this.ellipsoid, this.cameras = [], this.cameraMap = /* @__PURE__ */ new Map(), this.cameraInfo = [], this._upRotationMatrix = new S(), this._bytesUsed = /* @__PURE__ */ new WeakMap(), this._autoDisableRendererCulling = !0, this.manager = new b(), this._listeners = {};
	}
	...
	preprocessNode(e, t, n = null) {
		...
		let i = new S().copy(r).invert(), a = new Mt();
	...
	setTileActive(e, t) {
		...
		n && (t ? (n.parent = this.group, n.updateMatrixWorld(!0)) : this.visibleTiles.has(e) || (n.parent = null));
	}
	setTileVisible(e, t) {
	...
	constructor() {
		super(new oe(0, 0), new Zt()), this.renderOrder = Infinity;
	}
	onBeforeRender(e) {
...
}, Qt = /* @__PURE__ */ new w(), $t = /* @__PURE__ */ new w(), en = class {
	constructor() {
...
var an = .05, on = .025, R = /* @__PURE__ */ new S(), sn = /* @__PURE__ */ new S(), z = /* @__PURE__ */ new T(), B = /* @__PURE__ */ new T(), cn = /* @__PURE__ */ new T(), ln = /* @__PURE__ */ new T(), V = /* @__PURE__ */ new T(), H = /* @__PURE__ */ new T(), un = /* @__PURE__ */ new T(), dn = /* @__PURE__ */ new T(), U = /* @__PURE__ */ new C(), fn = /* @__PURE__ */ new ae(), W = /* @__PURE__ */ new T(), pn = /* @__PURE__ */ new T(), mn = /* @__PURE__ */ new T(), hn = /* @__PURE__ */ new C(), G = /* @__PURE__ */ new le(), gn = /* @__PURE__ */ new T(), _n = /* @__PURE__ */ new w(), K = /* @__PURE__ */ new w(), vn = /* @__PURE__ */ new w(), yn = /* @__PURE__ */ new w(), bn = /* @__PURE__ */ new w(), xn = /* @__PURE__ */ new w(), Sn = { type: "change" }, Cn = { type: "start" }, wn = { type: "end" }, Tn = 300, En = 30, Dn = 5, On = .0025, kn = class extends _ {
	...
	constructor(e = null, t = null, n = null) {
		super(), this.isEnvironmentControls = !0, this.domElement = null, this.camera = null, this.scene = null, this.tilesRenderer = null, this._enabled = !0, this.cameraRadius = 5, this.rotationSpeed = 1, this.minAltitude = 0, this.maxAltitude = .45 * Math.PI, this.minDistance = 10, this.maxDistance = Infinity, this.minZoom = 0, this.maxZoom = Infinity, this.zoomSpeed = 1, this.adjustHeight = !0, this.enableDamping = !1, this.dampingFactor = .15, this.enableDoubleTapZoom = !0, this.doubleTapZoomScale = 2, this.doubleTapZoomDuration = .25, this.fallbackPlane = new ae(new T(0, 1, 0), 0), this.useFallbackPlane = !0, this.enableFlight = !1, this.flightSpeed = 10, this.flightSpeedMultiplier = 4, this.scaleZoomOrientationAtEdges = !1, this.autoAdjustCameraRotation = !0, this.state = 0, this.pointerTracker = new en(), this.needsUpdate = !1, this.actionHeightOffset = 0, this.pivotPoint = new T(), this.zoomDirectionSet = !1, this.zoomPointSet = !1, this.zoomDirection = new T(), this.zoomPoint = new T(), this.zoomDelta = 0, this.rotationInertiaPivot = new T(), this.rotationInertia = new w(), this.dragInertia = new T(), this.inertiaTargetDistance = Infinity, this.inertiaStableFrames = 0, this.pivotMesh = new Xt(), this.pivotMesh.raycast = () => {}, this.pivotMesh.scale.setScalar(.25), this.raycaster = new ue(), this.raycaster.firstHitOnly = !0, this.up = new T(0, 1, 0), this._lastTime = performance.now(), this._keysDown = /* @__PURE__ */ new Set(), this._detachCallback = null, this._upInitialized = !1, this._lastUsedState = 0, this._zoomPointWasSet = !1, this._doubleTapZoomActive = !1, this._doubleTapZoomElapsed = 0, this._doubleTapPoint = new w(), this._lastTapTime = -Infinity, this._lastTapPoint = new w(), this._tilesOnChangeCallback = () => this.zoomPointSet = !1, n && this.attach(n), t && this.setCamera(t), e && this.setScene(e);
	}
	_getDeltaTime() {
	...
	_updateZoomDirection() {
		...
		i.getLatestPoint(K), rn(K, e, pn), L(t, pn, n), r.copy(t.ray.direction).normalize(), this.zoomDirectionSet = !0;
	}
	_updateZoomPoint() {
	...
	_setFrame(e) {
		...
		if (i && (a || this._updateZoomPoint())) {
			...
			nn(r, U, R), n.updateMatrixWorld(), n.matrixWorld.premultiply(R), n.matrixWorld.decompose(n.position, n.quaternion, B), this.zoomDirectionSet = !1, this._updateZoomDirection();
		}
...
}, An = /* @__PURE__ */ new S(), jn = /* @__PURE__ */ new S(), q = /* @__PURE__ */ new T(), J = /* @__PURE__ */ new T(), Y = /* @__PURE__ */ new T(), X = /* @__PURE__ */ new T(), Mn = /* @__PURE__ */ new T(), Nn = /* @__PURE__ */ new T(), Z = /* @__PURE__ */ new C(), Pn = /* @__PURE__ */ new C(), Fn = /* @__PURE__ */ new T(), In = /* @__PURE__ */ new T(), Q = /* @__PURE__ */ new le(), Ln = /* @__PURE__ */ new Je(), Rn = /* @__PURE__ */ new w(), zn = {}, Bn = 2550, Vn = class extends kn {
	get ellipsoidFrame() {
	...
	constructor(e = null, t = null, n = null) {
		super(e, t, n), this.isGlobeControls = !0, this._dragMode = 0, this._rotationMode = 0, this.maxZoom = .01, this._dragBaselineMatrix = new S(), this._dragBaselineRotation = new C(), this._dragBaselineSet = !1, this.nearMargin = .25, this.farMargin = 0, this.useFallbackPlane = !1, this.autoAdjustCameraRotation = !1, this.globeInertia = new C(), this.globeInertiaFactor = 0, this.ellipsoid = Ye.clone(), this.ellipsoidGroup = new y(), this._ellipsoidFrameInverse = new S();
	}
	setEllipsoid(e, t) {
	...
	setState(...e) {
		super.setState(...e), this._dragMode = 0, this._rotationMode = 0, this._dragBaselineSet = !1;
	}
	_updateInertia(e) {
	...
	_updatePosition(e) {
		if (this.state === 1) {
			...
			this._dragBaselineSet ||= (this._dragBaselineMatrix.copy(n.matrixWorld), this._dragBaselineRotation.identity(), !0), i.getCenterPoint(Rn), rn(Rn, a, Rn), An.copy(n.matrixWorld), n.matrixWorld.copy(this._dragBaselineMatrix), L(t, Rn, n), n.matrixWorld.copy(An), t.ray.applyMatrix4(s);
	...
	_updateZoom() {
		...
		if (a !== 3 && e === 0) return;
		this.rotationInertia.set(0, 0), this.dragInertia.set(0, 0, 0), this.globeInertia.identity(), this.globeInertiaFactor = 0, this._dragBaselineSet = !1;
		...
		if (this._isNearControls() || e > 0) {
			if (this._updateZoomDirection(), e < 0 && (this.zoomPointSet || this._updateZoomPoint())) {
				...
				let e = x.clamp(x.mapLinear(-Fn.dot(In), 1, .95, 0, 1), 0, 1), t = 1 - X.dot(In), i = r.isOrthographicCamera ? .05 : 1, a = x.clamp(o * 3, 0, 1), s = Math.min(e * t * i * a, .1);
...
}, $ = /* @__PURE__ */ new T(), Hn = /* @__PURE__ */ new T(), Un = /* @__PURE__ */ new re(), Wn = /* @__PURE__ */ new T(), Gn = /* @__PURE__ */ new T(), Kn = /* @__PURE__ */ new T(), qn = /* @__PURE__ */ new C(), Jn = /* @__PURE__ */ new C(), Yn = class extends _ {
	get animating() {
	...
	syncCameras() {
		...
		if ($.set(0, 0, -1).transformDirection(e.matrixWorld).normalize(), e.isPerspectiveCamera) {
			...
			let e = Math.abs(Hn.subVectors(t.position, i).dot($)), r = 2 * Math.tan(x.DEG2RAD * t.fov * .5) * e;
			n.zoom = (n.top - n.bottom) / r, n.updateProjectionMatrix();
		} else {
			let e = Math.abs(Hn.subVectors(n.position, i).dot($)), r = (n.top - n.bottom) / n.zoom * .5 / Math.tan(x.DEG2RAD * t.fov * .5);
	...
	_updateTransitionCamera() {
		...
		let a = Math.abs(Hn.subVectors(e.position, r).dot($)), o = 2 * Math.tan(x.DEG2RAD * e.fov * .5) * a, s = Jn.slerpQuaternions(e.quaternion, Un.quaternion, i), c = x.lerp(e.fov, 1, i), l = o * .5 / Math.tan(x.DEG2RAD * c * .5), u = Kn.copy(Un.position).sub(r).applyQuaternion(qn.copy(Un.quaternion).invert()), d = Gn.copy(e.position).sub(r).applyQuaternion(qn.copy(e.quaternion).invert()), f = Wn.lerpVectors(d, u, i);
		f.z -= Math.abs(f.z) - l;
		let p = -(d.z - f.z), m = -(u.z - f.z), h = x.lerp(p + e.near, m + Un.near, i), g = x.lerp(p + e.far, m + Un.far, i), _ = Math.max(g, 0) - Math.max(h, 0);
...
//#endregion
export { Se as _, It as a, bt as c, Ye as d, Ke as f, Ce as g, qe as h, Yt as i, ut as l, Je as m, Vn as n, zt as o, Ge as p, kn as r, kt as s, Yn as t, lt as u, _e as v };

//# sourceMappingURL=renderer-CUfHAmYW.js.map